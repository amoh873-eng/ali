...
public class SystemSettings
{
    ...
    // ── نقطة البيع: الحد الأقصى لأزرار الأصناف المعروضة في شبكة POS ──
    // قابل للتعديل من /settings (Admin/SuperAdmin). القيمة الافتراضية 30 مناسبة
    // لقوائم المطاعم (فئات صغيرة: مقبلات/رئيسية/مشروبات...)؛ القيم الأكبر تبطئ
    // العرض لأن كل زر عنصر DOM وأي تغيير يعيد رسم الشبكة.
    public int PosGridLimit { get; set; } = 30;
