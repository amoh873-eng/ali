...
public class Item : BaseEntity
{
    ...
    /// <summary>
    /// هل يُتتبّع هذا الصنف عبر دُفعات ItemBatch (تتبّع الدُفعات اختياري لكل صنف)؟
    /// الافتراضي false — لا يؤثر في الأصناف الأخرى. عند التفعيل يُصبح إدخال
    /// تاريخ الانتهاء إلزامياً عند استلام مخزون الصنف، والبيع يسحب FEFO مع
    /// منع بيع الدُفعات المنتهية.
    /// </summary>
